    ...
    <div className="w-full max-w-[1440px] mx-auto px-[8.4%] py-8">
      ...
      <div className="flex gap-[22px] flex-wrap">
        <StatCard
          ...
          icon="arrow-up"
        />
        <StatCard title="Aktywne kluby" value="150" icon="arrow-down" />
        <StatCard title="Liczba użytkowników" value="453" icon="users" />
        <StatCard title="Zgłoszenia oczekujące" value="23" icon="clock" />
      </div>
    </div>
  );
};
