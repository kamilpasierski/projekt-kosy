...
interface BanerProps {
  userName?: string; // Tutaj wpada Twoja nazwa, np. "test 1 2 3 4"
  avatarImage?: string;
  clubId?: number;
...
export default function Baner({
  ...
  return (
    ...
    <div className="relative w-full h-[594px] -mt-[85px] antialiased overflow-hidden font-['Montserrat']">
      ...
      <div className="relative h-full w-full flex flex-col items-center justify-center pt-[40px] z-10">
        ...
        <div className="flex flex-col items-center mt-[25px]">
          {/* Główna nazwa użytkownika - 48px Bold */}
